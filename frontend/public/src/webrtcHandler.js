export default class WebRTCHandler {
    ...
    async setupLocalStream() {
        try {
            ...
            await this.ui.setLocalVideo(this.localStream);
        } catch (error) {
    ...
    setupDataChannel(channel) {
        ...
        channel.onmessage = (event) => {
            console.warn('Received message via data channel:', event.data);
            // Note: Chat messages are now handled via WebSocket, so this is a fallback.
